...
from mysite.base.dbapp.custom_model_view import AppPageView, GridModelView
...
urlpatterns = patterns('',
                       ...
                       (r'^iclock/file/(?P<path>.*)$', 'django.views.static.serve',
                        {'document_root': ADDITION_FILE_ROOT}),
