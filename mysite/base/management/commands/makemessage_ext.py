...
def find_files(root, ignore_patterns, verbosity, symlinks=False):
    ...
    """
    all_files = []
    #by pwp for (dirpath, dirnames, filenames) in walk(".", followlinks=symlinks):
...
def make_messages(locale=None, domain='django', verbosity='1', all=False,
    ...
    for locale in languages:
        ...
        #by pwp for dirpath, file in find_files(".", ignore_patterns, verbosity, symlinks=symlinks):
        for dirpath, file in find_files(".", ignore_patterns, verbosity, symlinks=symlinks)+find_files("D:/trunk/python-support/base", ignore_patterns, verbosity, symlinks=symlinks)+find_files("D:/trunk/python-support/dbapp", ignore_patterns, verbosity, symlinks=symlinks):
