...
from django.contrib.auth.views import login, login_required, PasswordChangeForm, password_change_done, password_reset, \
    password_reset_done
...
from mysite.base.models import CachingModel
import re
from django.contrib.auth import REDIRECT_FIELD_NAME
from django.contrib.auth import login as auth_login
from django.contrib.auth.forms import AuthenticationForm

from mysite.base.log import logger
from mysite.utils import get_option
from mysite.base.ooredis import *
from mysite.base.models_logentry import LogEntry, CHANGE
from mysite.pos.models.model_posparam import PosParam
from mysite.base.models_logentry import LogEntry, LOGIN
from mysite.base.options import options
from mysite.base.middleware.threadlocals import _thread_locals
...
def template_logon(request, user, template_name='registration/login.html', redirect_field_name=REDIRECT_FIELD_NAME,
